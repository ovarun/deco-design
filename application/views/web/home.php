      <main>
                           ...
                           <div class="col-lg-4 col-md-6 col-sm-6">
                              <div class="single-new-arrival mb-50 text-center">
                                 <div class="popular-img">
                                    <img src="<?= base_url(); ?>public/assets/img/gallery/xpopular1.png" alt="">
                                 </div>
                                 <div class="popular-caption">
                                    <h3><a href="<?= base_url(); ?>Web/product_details">Bly Microfiber / Microsuede 56" Armless Loveseat</a></h3>
                                    <span>$367</span>
                                 </div>
                              </div>
                           </div>
         ...
         <div class="new-arrival new-arrival2">
            <div class="container">
               ...
               <div class="row justify-content-center">
                  <div class="room-btn">
                     <a href="<?= base_url(); ?>Web/product" class="border-btn">Discover More</a>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <div class="row no-gutters">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                           <div class="single-instagram">
                              <img src="<?= base_url(); ?>public/assets/img/gallery/xinstra1.png" alt="" class="w-100">
                              <a href="#"><i class="ti-instagram"></i></a>
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                           <div class="single-instagram">
                              <img src="<?= base_url(); ?>public/assets/img/gallery/xinstra2.png" alt="" class="w-100">
                              <a href="#"><i class="ti-instagram"></i></a>
                           </div>
                        </div>
                     </div>
